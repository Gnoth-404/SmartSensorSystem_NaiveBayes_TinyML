...
{
	pthread_t t_ServerThread, t_MeasureThread, t_TimeThread, t_ButtonThread;
	pthread_attr_t attr;
	void *th_status;
	...
	pthread_create( &t_ButtonThread,	&attr, (void *)&ButtonThread,	NULL );
	...
	pthread_join( t_ButtonThread,	&th_status );
